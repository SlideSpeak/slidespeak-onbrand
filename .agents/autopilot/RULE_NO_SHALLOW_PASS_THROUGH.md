...
- The interface is nearly as complex as the implementation and does not hide validation,
  translation, policy, orchestration, or error handling.
...
- Public exports that intentionally stabilize a package interface while hiding internal file
  structure.
...
Inline the pass-through call, or deepen the module by moving meaningful behavior behind the
interface.
